...
description: ES添削・下書き生成プロンプトの設計・最適化・A/Bテスト。backend/app/prompts/ の品質改善を担う。
command_description: ES添削・下書き生成プロンプトの設計・テスト・最適化を行う。
cursor_description: ES添削・下書き生成プロンプトの設計・テスト・最適化を行う。
---
