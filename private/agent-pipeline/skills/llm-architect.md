---
name: llm-architect
description: マルチモデル（Claude/GPT-5.4/Gemini）ルーティング、RAG+LLM統合、コスト最適化、フォールバック設計を担う。
command_description: LLMアーキテクチャの設計・モデルルーティング・コスト最適化を行う。
cursor_description: LLMアーキテクチャの設計・モデルルーティング・コスト最適化を行う。
---
