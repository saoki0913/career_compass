# データベースと Supabase（PostgreSQL）

**最終更新**: 2026-03-21

**この文書の目的**: Supabase / PostgreSQL の接続設定、ローカルと本番、マイグレーション、RLS、トラブルシュートをまとめます。

**移行メモ**: 旧 `SUPABASE_SETUP.md` と `DB_OPERATIONS.md` を統合しました。

就活Pass のローカル開発環境と本番環境におけるデータベース運用方法をまとめます。

---

## Supabase Cloud: 初回のつなぎ方（要約）
