...
- [ ] UptimeRobot の 8 monitors と email alert を確認（詳細は `docs/ops/MONITORING_SETUP.md`）
...
- Sentry projects: `career-compass-frontend` / `career-compass-backend` active。Replay は off。
