...
| **Ref** | 環境変数チェックリスト | [ENVIRONMENT_VARIABLES.md](../operations/platform/ENVIRONMENT_VARIABLES.md) |
...
[../operations/production/RUNBOOK.md](../operations/production/RUNBOOK.md) を起点に、シナリオに応じた手順書を参照してください。

| ドキュメント | 内容 |
|---|---|
| [RUNBOOK.md](../operations/production/RUNBOOK.md) | 運用ランブック（シナリオ選択の入口） |
| [ENVIRONMENT_VARIABLES.md](../operations/platform/ENVIRONMENT_VARIABLES.md) | 本番環境変数チェックリスト |
| [SECRETS_MANAGEMENT.md](../operations/production/SECRETS_MANAGEMENT.md) | シークレット管理 |
| [DB_MIGRATION.md](../operations/production/DB_MIGRATION.md) | DB マイグレーション手順（分類・安全ゲート） |
| [STRIPE.md](./setup/STRIPE.md) | Stripe 本番設定・運用 |
| [REGULAR_RELEASE.md](../operations/production/REGULAR_RELEASE.md) | 通常リリース手順（develop → main） |
| [INCIDENT_ROLLBACK.md](../operations/production/INCIDENT_ROLLBACK.md) | 障害対応・ロールバック手順 |
