...
> **WHY**: trigger、function、RLS、constraint、data update は shared DB 上で旧コードと新コードの両方に影響する。人間が SQL と影響範囲を確認する必要がある。
...
ローカル開発の Supabase 起動やリセットは [../../setup/DB_SUPABASE.md](../../setup/DB_SUPABASE.md) を参照（本番 Supabase の構築は [./../setup/SUPABASE.md](../setup/SUPABASE.md)）。
