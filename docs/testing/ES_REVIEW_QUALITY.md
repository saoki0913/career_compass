...
| AI smell tier 2 threshold (gakuchika short) | `3.0` | `backend/app/services/es_review/ai_smell.py` |
| AI smell tier 2 threshold (_default mid_long) | `4.0` | `backend/app/services/es_review/ai_smell.py` |
