...
const landingRootDescription =
  "就活Pass（シューパス）は、ES添削・志望動機AI・ガクチカAI・企業別AI模擬面接をひとつにまとめた就活AIアプリ。登録した企業の採用ページ情報を自動で取り込み、企業固有性の薄い言い回しは深掘りに回します。月0円のFreeプランから試せます。有料プランへ変更する場合は決済画面で支払い情報を入力します。";
