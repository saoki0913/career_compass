/**
 * Interview read-model: DB row parsing, normalization, and restoration helpers.
 *
 * These functions bridge the gap between raw Postgres jsonb / text columns
 * and the typed domain objects used in the interview service layer.
 */
import {
