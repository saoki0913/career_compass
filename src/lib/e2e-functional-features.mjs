...
const FEATURE_CONFIG = {
  "es-review": {
    ...
    patterns: [
      ...
      /^backend\/app\/prompts\/es_reference_guidance\.py$/u,
      /^backend\/scripts\/es_review\/generate_es_reference_guidance\.py$/u,
  ...
  interview: {
    ...
    patterns: [
      ...
      /^src\/lib\/interview\/.+/u,
      /^src\/shared\/contracts\/interview\/role-options\.ts$/u,
      /^src\/app\/api\/companies\/\[id\]\/interview\/.+/u,
      /^src\/app\/api\/companies\/\[id\]\/es-role-options\/route\.ts$/u,
      ...
      /^e2e\/functional\/interview-role-selection\.spec\.ts$/u,
    ],
  },
  "company-info-search": {
