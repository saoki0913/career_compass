  ...
  return (
    ...
    >
      <div
        ...
        className={cn("flex h-10 cursor-pointer select-none items-center gap-2 rounded-xl px-4 shadow-[0_16px_32px_-24px_rgba(15,23,42,0.9)] sm:h-11 lg:h-10 lg:px-3", COLUMN_HEADER_COLORS[phase.color])}
      >
        ...
        <span className="ml-auto flex h-7 w-7 items-center justify-center text-white/70">
