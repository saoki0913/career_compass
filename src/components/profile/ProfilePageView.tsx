...
import type { AccountProfileData } from "@/lib/server/account-loaders";
...
export default function ProfilePageView({ profile, companyCount, esStats }: ProfilePageViewProps) {
  const { total: esTotal, draftCount, publishedCount } = esStats;
            ...
            {profile.image ? (
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  利用開始: {formatDate(profile.createdAt ?? undefined)}
                </p>
              </div>
            </div>
          </CardContent>
