...
export const FILTER_BAR_SURFACE_CLASS =
  "rounded-[1.1rem] border border-slate-200/80 bg-white/92 p-2.5 min-[390px]:p-3 shadow-[0_18px_48px_-34px_rgba(15,23,42,0.45)] backdrop-blur-xl lg:rounded-xl lg:px-2 lg:py-1.5";
...
export const FILTER_BAR_INPUT_CLASS =
  "h-[52px] min-[390px]:h-[56px] w-full rounded-[1.1rem] border border-slate-200 bg-white pl-12 pr-4 text-[15px] shadow-[0_14px_34px_-28px_rgba(15,23,42,0.55)] transition-colors placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15 lg:h-8 lg:rounded-lg lg:pl-8 lg:pr-2.5 lg:text-xs lg:shadow-none";

export const FILTER_BAR_SELECT_TRIGGER_CLASS =
  "h-11 min-[390px]:h-12 min-w-0 shrink-0 rounded-xl text-[15px] lg:h-8 lg:w-[7rem] lg:rounded-lg lg:px-2 lg:text-xs";
...
export const FILTER_BAR_STATUS_ROW_CLASS =
  "col-span-2 flex w-full min-w-0 max-w-full flex-nowrap items-center gap-1.5 min-[390px]:gap-2 overflow-x-auto overscroll-x-contain pb-1 [-ms-overflow-style:none] [scrollbar-width:thin] [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-slate-300/80 lg:col-span-1 lg:w-auto lg:flex-[0_1_auto] lg:gap-1 lg:overflow-visible lg:pb-0 lg:[scrollbar-width:none] lg:[&::-webkit-scrollbar]:hidden";

export const FILTER_BAR_STATUS_TAB_CLASS =
  "flex h-9 min-[390px]:h-10 max-w-[9rem] shrink-0 cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-full px-3 min-[390px]:px-3.5 text-[12px] min-[390px]:text-[13px] font-semibold transition-all duration-200 lg:h-8 lg:max-w-[4.9rem] lg:min-w-0 lg:shrink lg:gap-1 lg:px-1.5 lg:text-[11px]";

export const FILTER_BAR_STATUS_COUNT_CLASS =
  "rounded-full px-1.5 min-[390px]:px-2 py-0.5 text-[11px] min-[390px]:text-xs font-medium transition-colors duration-200 lg:px-1 lg:text-[10px]";
