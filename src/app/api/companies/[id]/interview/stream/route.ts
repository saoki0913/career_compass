...
import { DEFAULT_INTERVIEW_QUESTION_COUNT } from "@/lib/interview/session";

import { buildInterviewContext, validateInterviewMessages } from "../shared";
import {
  createInterviewProxyStream,
  createInterviewQuestionFlowCompleteStream,
} from "../stream-utils";
...
export async function POST(
  ...
  if (answerCount >= DEFAULT_INTERVIEW_QUESTION_COUNT) {
    return createInterviewQuestionFlowCompleteStream({ messages });
  }
