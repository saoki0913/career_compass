...
export default function GakuchikaListPage() {
  ...
  /** GET /api/gakuchika が一度でも成功したら true（未取得の 0,0 で上限 UI を出さない） */
  ...
  const isAtLimit =
    quotaLoaded && maxCount > 0 && currentCount >= maxCount;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {/* Filter bar: 実バーはデータがあるときのみ。読み込み中はレイアウト合わせでスケルトンのみ */}
