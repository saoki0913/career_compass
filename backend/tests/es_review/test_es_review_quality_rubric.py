...
def test_es_review_quality_rubric_cases(reference_payload: None) -> None:
    cases = [
        ...
        ESReviewRubricCase(
            name="role_course_reason_role_and_company_axes",
            ...
            role_name="デジタル企画",
            user_facts=[
                {"source": "current_answer", "text": "事業理解と技術理解をつなぐ仕事に関心がある。"},
                {"source": "document_section", "text": "自己PR: 研究で関係者調整を担った。"},
                {"source": "profile", "text": "志望職種: デジタル企画"},
            ],
            rag_sources=[
                {"content_type": "employee_interviews", "title": "デジタル企画の社員インタビュー", "excerpt": "事業部門と開発をつなぐ"},
                {"content_type": "corporate_site", "title": "事業戦略", "excerpt": "成長領域への投資を進める"},
                {"content_type": "new_grad_recruitment", "title": "求める人物像", "excerpt": "若手の挑戦を後押しする"},
            ],
            expected_themes={"役割理解", "事業理解"},
            required_user_sources={"current_answer", "document_section"},
            min_coverage_level="strong",
            expected_weak_notice=False,
        ),
        ESReviewRubricCase(
            name="intern_goals_program_and_growth_axes",
            ...
            user_facts=[
                {"source": "current_answer", "text": "データ分析を価値に変える視点を実務で磨きたい。"},
                {"source": "gakuchika_summary", "text": "研究で分析結果の示し方を改善した。"},
                {"source": "profile", "text": "志望職種: Business Intelligence"},
            ],
            rag_sources=[
                {"content_type": "new_grad_recruitment", "title": "Business Intelligence Internship", "excerpt": "実務に近いテーマを扱う"},
                {"content_type": "employee_interviews", "title": "社員インタビュー", "excerpt": "分析を事業判断につなげる"},
                {"content_type": "corporate_site", "title": "事業紹介", "excerpt": "データ活用を通じて価値を広げる"},
            ],
            expected_themes={"インターン機会", "成長機会"},
            required_user_sources={"current_answer", "gakuchika_summary"},
            min_coverage_level="strong",
            expected_weak_notice=False,
        ),
