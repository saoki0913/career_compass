...
Usage:
  python backend/scripts/company_info/audit_official_misclassification.py
  python backend/scripts/company_info/audit_official_misclassification.py --limit 5
  python backend/scripts/company_info/audit_official_misclassification.py --max-results 10 --cache-mode refresh
  python backend/scripts/company_info/audit_official_misclassification.py --all
"""
...
def _filter_hybrid_results(
    ...
    for result in results:
        ...
        confidence = _hybrid_score_to_confidence(
            adjusted_score,
            source_type,
            year_matched=(not adjust_for_year) or result.year_matched,
        )
        ...
        filtered.append(
            {
                ...
                "relation_company_name": (
                    relation["relation_company_name"]
