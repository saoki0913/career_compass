...
Usage:
    # 特定の親会社の不足子会社を検出
    python backend/scripts/company_info/find_missing_subsidiaries.py "NTTデータ"

    # 全主要グループを検索
    python backend/scripts/company_info/find_missing_subsidiaries.py --all

    # 結果をJSONファイルに出力
    python backend/scripts/company_info/find_missing_subsidiaries.py --all --output suggestions.json

    # 登録済み子会社を表示
    python backend/scripts/company_info/find_missing_subsidiaries.py --show "NTTデータ"
