...
Usage:
    python backend/evals/company_info_search/cli/generate_popular_companies.py
"""
...
def main():
    ...
    output_path = backend_root / "evals" / "company_info_search" / "fixtures" / "popular_companies_300.json"
