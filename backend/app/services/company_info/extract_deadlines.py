...
ExtractedDeadline: Any = None
ExtractedDocument: Any = None
ExtractedItem: Any = None
...
def configure_dependencies(
    *,
    ...
    global _get_graduation_year, SCHEDULE_MIN_TEXT_CHARS
    global ExtractedDeadline, ExtractedDocument, ExtractedItem, ExtractedScheduleInfo

    _get_graduation_year = candidate_scoring._get_graduation_year
    SCHEDULE_MIN_TEXT_CHARS = config.SCHEDULE_MIN_TEXT_CHARS
    ExtractedDeadline = models.ExtractedDeadline
    ExtractedDocument = models.ExtractedDocument
    ExtractedItem = models.ExtractedItem
    ExtractedScheduleInfo = models.ExtractedScheduleInfo


@dataclass(frozen=True)
class PendingDeadline:
    """Deadline candidate before user confirmation in the Next.js layer."""
