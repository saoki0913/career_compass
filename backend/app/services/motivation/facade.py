"""Motivation FastAPI facade implementation for the CA-1A service layer."""
...
from app.services.motivation.pipeline import (
...
from app.services.motivation.draft import (
...
async def get_next_question_stream(
    ...
    from app.services.motivation.streaming import (
