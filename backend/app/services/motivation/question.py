...
from app.services.motivation.context import (
...
from app.services.motivation.models import DeepDiveGap, MotivationScores, NextQuestionRequest, NextQuestionResponse
from app.services.motivation.planner import _slot_label
...
from app.services.motivation.validation import (
...
if TYPE_CHECKING:
    from app.services.motivation.pipeline import _MotivationQuestionPrep
...
def _repair_generated_question_for_response(
    *,
    ...
    from app.services.motivation.validation import _validate_or_repair_question
...
def _resolve_call_llm_with_error():
    try:
        from app.services.motivation import facade_dependencies as motivation_router
