...
TEMPLATE_DEF: TemplateDef = {
    ...
    "rewrite_policy": {
        ...
        "structure_short": "1文目で価値観の核、2文目で根拠経験、必要なら3文目で仕事との接点を置く",
    ...
    "validation_policy": {
        ...
        "evaluation_axes": [
            {"name": "価値観の核の明示", "pass_condition": "大切にする価値観が具体的な行動指針として示されている", "rewrite_instruction": "挑戦、チームワーク等の一語で終えず、行動レベルで定義する"},
