...
TEMPLATE_DEF: TemplateDef = {
    ...
    "rewrite_policy": {
        ...
        "structure_short": "1文目で学びたいこと、2文目で根拠経験、必要なら3文目でインターン接点を置く",
    ...
    "validation_policy": {
        ...
        "evaluation_axes": [
            {"name": "学びの核の明示", "pass_condition": "インターンで達成したい目標が1点に絞られている", "rewrite_instruction": "いろいろ学びたいを避け、何をできるようにするかを書く"},
