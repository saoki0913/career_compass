...
- 学び: 30 字以下で締める。「培った」「身につけた」を使い、「学んだ」「実感した」「再現できる」等の定型結びは禁止
...
- 学び: 40 字以下で締める。「培った」「身につけた」を使い、「学んだ」「実感した」「再現できる」「次に活きる」等の定型結びは禁止
...
- 学び: 50 字以下で締める。「培った」「身につけた」を使い、「学んだ」「実感した」「再現できる」「次に活きる」等の定型結びは禁止
