...
{{{{
  "slot_status": {{{{
    ...
    "company_reason": "filled_strong|filled_weak|partial|missing",
    "self_connection": "filled_strong|filled_weak|partial|missing",
    "desired_work": "filled_strong|filled_weak|partial|missing",
    "value_contribution": "filled_strong|filled_weak|partial|missing",
    "differentiation": "filled_strong|filled_weak|partial|missing"
  }}}},
